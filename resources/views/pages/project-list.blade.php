...
@section('content')
@include('layouts.navbar.topnav', ['title' => 'Project List'])
<div class="container">
    <CENTER>
    ...
    <div class="card mb-4">
        <center>
            <h5 class="mt-3 mb-3" style="color: #707070;">Project List</h5>
           
            <div>
                <a href="{{ route('add_new_project') }}" class="btn btn-rounded btnGreen rubik-font">Add New Project</a>
                <a href="{{ route('project_draft') }}" class="btn btn-rounded btnGreen rubik-font" style="margin-left: 5px;">Project Draft</a>
                <a href="{{ route('project_dropped') }}" class="btn btn-rounded btnGreen rubik-font" style="margin-left: 5px;">Project Dropped</a>
                <a href="{{ route('schedule_view') }}" class="btn btn-rounded btnGreen rubik-font" style="margin-left: 5px;">Schedule View</a>
            </div>
        </center>
        ...
        if (!dataTable) {
            dataTable = $('#projectTable').DataTable({
                ...
                columns: [
                            ...
                            { data: 'ProductEngineer', title: 'Product Eng' },
                            { data: 'Status', title: 'Status',
                                            render: function (data, type, row) {
                                                ...
                                                } else if (data === 'Preliminary' || data === 'BOM Input' || data === 'Prep 1st Cost' || data === '1st Cost' || data === '1st Cost CR') {
                                ...
                                render: function (data, type, row) {
                                    var dropdownHtml = '<span>' +
                                        ...
                                        '<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">' +
                                            '<a class="dropdown-item" href="/project-detail/' + row.ProjectNumber + '">' +
