...
@section('content')
@include('layouts.navbar.topnav', ['title' => 'Project Draft'])
<div class="container">
    <CENTER>
    ...
    <div class="card mb-4">
        <center>
            <h5 class="mt-3" style="color: #707070;">Project Draft</h5>
            <br>
                                    ...
                                    },
                                    {
                                        ...
                                        render: function(data, type, row) {
                                            var buttonHtml = '<a style="margin-right: 5px;" class="btn btn-primary text-white" title="See Project Detail" href="/project-detail/' + row.ProjectNumber + '"><i class="fa fa-search"></i></a>' +
                                                '<button style="margin-right: 5px;" class="btn btn-success btn-prelim text-white" title="Project Update to Preliminary" data-id="' + row.ProjectNumber + '"><i class="fa fa-level-up" aria-hidden="true"></i></button>'+
                                                '<button class="btn btn-danger btn-delete text-white" title="Delete Project" data-id="' + row.ProjectNumber + '"><i class="fa fa-trash" aria-hidden="true"></i></button>';
